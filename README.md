...
[Quem sou eu.pptx](https://github.com/user-attachments/files/25590904/Quem.sou.eu.pptx)
## Gráfico de despesas da Prefeitura de São José dos Campos
Trabalho executado via Excel: Gráfico dinâmico, tabela, formatação e uso de funções (SOMASE, CONT.SE)
